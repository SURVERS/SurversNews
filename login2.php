...
<body>
	...
	<div id="block_login">
		...
		<form action="checklogin.php" method="POST">
			<input type="text" name="login_text" placeholder="Неверный логин или пароль" class="input_error"><br><br>
			<input type="password" name="password_text" placeholder="Неверный логин или пароль" class="input_error"><br><br>
